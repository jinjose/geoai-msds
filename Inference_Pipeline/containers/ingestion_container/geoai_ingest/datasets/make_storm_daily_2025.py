...
# ---- configure these ----
INPUT_GZ = r"./StormEvents_details-ftp_v1.0_d2025_c20260224.csv.gz"  # downloaded file
OUT_PARQUET = "storm_daily_2025.parquet"
S3_BUCKET = "geoai-demo-data"
S3_KEY = "raw/dataset=storm/state_fips=19/county_fips=ALL/granularity=daily/year=2025/storm_daily_2025.parquet"
# -------------------------
