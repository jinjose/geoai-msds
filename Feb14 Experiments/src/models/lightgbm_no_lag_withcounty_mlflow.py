...
def run_lightgbm_no_lag_mlflow_county(
    ...
    # ======================================================
    # LOCK COUNTY CATEGORIES GLOBALLY
    # ======================================================
    ...
    for i in range(1, len(years)):
        ...
        drop_cols = [target_col, "year", "lag1_yield"]
        ...
        # Reapply locked categorical levels
    ...
    X_full = feature_df[feature_cols].copy()
